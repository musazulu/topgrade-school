...
def enrollment_apply(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            # FIX: use namespace because you included the app with namespace="enrollment"
            return redirect("enrollment:enrollment_success", application_id=application.application_id)
    else:
        form = EnrollmentForm()
